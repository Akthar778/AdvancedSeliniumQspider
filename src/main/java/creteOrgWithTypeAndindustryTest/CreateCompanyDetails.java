...
public class CreateCompanyDetails {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement CreateNewOrganizationTitle = driver.findElement(By.xpath("//span[@class=\"lvtHeaderText\"]"));
		WebElement titileOfOrg = driver.findElement(By.xpath("//span[text()='Creating New Organization']"));
		if (CreateNewOrganizationTitle.equals(titileOfOrg))
